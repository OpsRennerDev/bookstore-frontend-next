...
export default function BookCard({book}: Readonly<BookCardProps>){
  return(
    ...
    ">
      <img src="https://placehold.co/150x220" alt="Capa do livro" className=" w-full h-56 object-cover rounded-lg mb-4"/>
      <h3 className="text-lg font-semibold text-gray-800">{book.book_name}</h3>
